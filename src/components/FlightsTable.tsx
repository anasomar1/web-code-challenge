...
import { SaveButton, SearchInput, StyledTable, TableCell, TableContainer, TableHeader } from "./StyledComponents";
import FlightsSearch from "./FlightsSearch";

const FlightsTable = () => {
  const { data, editedCells, updateCell, saveChanges, debouncedFilter, setTableData } =
    useTableData();
